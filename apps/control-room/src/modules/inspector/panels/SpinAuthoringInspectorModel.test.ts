...
describe("spin authoring opaque compatibility records", () => {
  ...
  it("keeps canonical variants writable", () => {
    ...
    expect(isUnsupportedSpinAuthoringResource("spin_torque", { kind: "slonczewski", id: "s", formula_version: "slonczewski.fullmag.v2", schema_version: null, current_density: null, current_source: " charge ", spin_polarization: [0, 0, 1], degree: 0.4, lambda_asymmetry: 1, epsilon_prime: 0, free_layer_thickness_m: null, fixed_layer_position: "top", target: { object_id: "body", region_id: null }, stack_normal: [0, 0, 1], realization: { kind: "thin_layer_homogenized", realization_version: "slonczewski_thin_layer_homogenized.v1" } })).toBe(false);
  ...
  it("keeps malformed known-kind and future-version records opaque", () => {
    ...
    const slon = { kind: "slonczewski", formula_version: "slonczewski.fullmag.v2", spin_polarization: [0, 0, 1], degree: 0.4, lambda_asymmetry: 1, epsilon_prime: 0 };
