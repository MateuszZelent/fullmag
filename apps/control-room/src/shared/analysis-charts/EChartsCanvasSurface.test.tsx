...
describe("EChartsCanvasSurface", () => {
  ...
  it("applies a pinned SI range after mount, update, and remount without fetching data", async () => {
    ...
    expect(first?.dispatchAction).toHaveBeenCalledWith(
      { type: "dataZoom", startValue: 2, endValue: 8 },
      { silent: true },
    );
    ...
    expect(first?.dispatchAction).toHaveBeenCalledWith(
      { type: "dataZoom", startValue: 3, endValue: 7 },
      { silent: true },
    );
    ...
    expect(second?.dispatchAction).toHaveBeenCalledWith(
      { type: "dataZoom", startValue: 4, endValue: 6 },
      { silent: true },
    );
