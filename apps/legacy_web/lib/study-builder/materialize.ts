...
function primitivePayloadToStage(node: MaterializablePrimitiveNode): ScriptBuilderStageState {
  ...
  return {
    ...
    eigen_k_path: toStringOr(payload.eigen_k_path, ""),
