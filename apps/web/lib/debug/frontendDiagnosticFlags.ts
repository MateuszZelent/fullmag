...
const DEFAULT_FRONTEND_DIAGNOSTIC_FLAGS = {
  ...
  leakIsolation: {
    ...
    enableFemMeshView3DSceneMountWithoutVisualContent: true,
    enableFemMeshView3DGeometryRender: false,
    enableFemMeshView3DArrowRender: false,
    enableFemMeshView3DOverlayRender: false,
    enableFemMeshView3DSharedColorFieldCollection: false,
    enableFemMeshView3DSharedVertexColorPrecompute: false,
    enableFemMeshView3DGeometryColorUpload: false,
    enableFemMeshView3DMemoryDiagnostics: false,
  ...
  diagnosticConsole: {
    enableFrontendRuntimeLogs: false,
  },
