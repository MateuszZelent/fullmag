...
describe("frontendDiagnosticFlags loader", () => {
  ...
  it("contains leak isolation kill switches in defaults", () => {
    ...
    expect(defaults.leakIsolation.enableFemMeshView3DSceneMountWithoutVisualContent).toBe(false);
    expect(defaults.leakIsolation.enableFemMeshView3DGeometryRender).toBe(false);
    expect(defaults.leakIsolation.enableFemMeshView3DArrowRender).toBe(false);
    expect(defaults.leakIsolation.enableFemMeshView3DOverlayRender).toBe(false);
    expect(defaults.leakIsolation.enableFemMeshView3DSharedColorFieldCollection).toBe(false);
    expect(defaults.leakIsolation.enableFemMeshView3DSharedVertexColorPrecompute).toBe(false);
    expect(defaults.leakIsolation.enableFemMeshView3DGeometryColorUpload).toBe(false);
    expect(defaults.leakIsolation.enableFemMeshView3DMemoryDiagnostics).toBe(false);
    expect(defaults.leakIsolation.enableFemMeshView3DAutoFit).toBe(false);
    expect(defaults.leakIsolation.enableFemMeshView3DAutoFitGenerationEffect).toBe(false);
    expect(defaults.leakIsolation.enableFemMeshView3DBlankViewportRecovery).toBe(false);
    expect(defaults.leakIsolation.enableFemMeshView3DAutoFitComponent).toBe(false);
    expect(defaults.leakIsolation.enableFemMeshView3DAutoFitCameraApply).toBe(false);
    expect(defaults.leakIsolation.enableFemMeshView3DAutoFitInvalidate).toBe(false);
    expect(defaults.leakIsolation.enableFemMeshView3DAutoFitRecord).toBe(false);
    expect(defaults.leakIsolation.enableLegacyBinaryFemTopologyHydration).toBe(false);
  ...
  it("provides a leak-isolation diagnostic profile", () => {
    ...
    expect(profile?.overrides.leakIsolation?.enableFemMeshView3DSceneMountWithoutVisualContent).toBe(false);
    ...
    expect(profile?.overrides.leakIsolation?.enableFemMeshView3DSharedColorFieldCollection).toBe(false);
    expect(profile?.overrides.leakIsolation?.enableFemMeshView3DSharedVertexColorPrecompute).toBe(false);
    expect(profile?.overrides.leakIsolation?.enableFemMeshView3DGeometryColorUpload).toBe(false);
    expect(profile?.overrides.leakIsolation?.enableFemMeshView3DMemoryDiagnostics).toBe(false);
