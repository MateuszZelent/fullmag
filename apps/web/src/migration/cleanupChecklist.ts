...
const CLEANUP_ITEMS: CleanupItem[] = [
  ...
  { id: "preview-component", description: "POST /preview/component → PUT /display", module: "lib/liveApiClient.ts", status: "deprecated" },
  { id: "preview-everyN", description: "POST /preview/everyN → PUT /display", module: "lib/liveApiClient.ts", status: "deprecated" },
  { id: "preview-maxPoints", description: "POST /preview/maxPoints → PUT /display", module: "lib/liveApiClient.ts", status: "deprecated" },
  { id: "preview-layer", description: "POST /preview/layer → PUT /display", module: "lib/liveApiClient.ts", status: "deprecated" },
  { id: "preview-allLayers", description: "POST /preview/allLayers → PUT /display", module: "lib/liveApiClient.ts", status: "deprecated" },
  { id: "preview-autoScale", description: "POST /preview/autoScaleEnabled → PUT /display", module: "lib/liveApiClient.ts", status: "deprecated" },
  { id: "preview-selection", description: "POST /preview/selection → PUT /display", module: "lib/liveApiClient.ts", status: "deprecated" },
