...
export function meshOptionsFromBuilder(
  ...
  return {
    ...
    edgeHMax: builder.edge_hmax ?? "",
    edgeThickness: builder.edge_thickness ?? "",
    cornerHMax: builder.corner_hmax ?? "",
    cornerExtent: builder.corner_extent ?? "",
...
export function meshOptionsToBuilder(
  ...
  return {
    ...
    edge_hmax: options.edgeHMax,
    edge_thickness: options.edgeThickness,
    corner_hmax: options.cornerHMax,
    corner_extent: options.cornerExtent,
