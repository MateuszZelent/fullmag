...
const ICON_REGISTRY: Record<NodeKind, IconRegistryEntry> = {
  ...
  "object.material":                       { token: "atom",             label: "Material" },
  "object.material.properties":            { token: "sliders",          label: "Material Properties" },
  "object.initial_state":                  { token: "compass",          label: "Initial State" },
  "object.initial_state.texture":          { token: "paintbrush",       label: "Magnetization Texture" },
