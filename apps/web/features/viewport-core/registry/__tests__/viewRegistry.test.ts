...
describe("viewRegistry", () => {
  ...
  it("routes every 3D/Mesh workspace variant to unified 3D component", () => {
    const cases: Array<Partial<WorkspaceViewContext>> = [
      ...
      { viewportMode: "3D", hasSessionData: false, discretization: "fem" },
      { viewportMode: "3D", hasSessionData: false, discretization: "fdm" },
      { viewportMode: "3D", hasSessionData: false, discretization: null },
