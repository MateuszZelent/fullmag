...
| `Problem.parameters` | `ParameterLibrary \| None` | `None` | mixed | versioned SI-normalized authoring parameters; references and cycles resolved at construction | `parameters` |
