"""Managed FEM fixture for the session-resolved Default planar-source gate."""
...
study = fm.study("viewport_2d_default_slice_fem_smoke")
study.engine("fem")
...
study.universe.mesh(minimum_element_size=5 * NM, maximum_element_size=20 * NM)
