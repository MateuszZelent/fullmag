"""Strict one-layer mixed-P1 FEM fixture for the viewport-3D topology smoke.

Run with:
    fullmag --dev -i examples/viewport_3d_mixed_topology_smoke.py
"""
...
NM = 1e-9
MAX_STEPS = int(os.environ.get("FULLMAG_VIEWPORT3D_MIXED_TOPOLOGY_MAX_STEPS", "50"))


fm.reset()
study = fm.study("viewport_3d_mixed_topology_smoke")
study.mode("strict")
study.engine("fem")
...
study.airbox.visualization(show=True, mode="vectors", active_quantity_id="h_eff", wireframe=True)
