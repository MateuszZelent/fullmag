...
AIRBOX_HMAX = 500e-9
AIRBOX_HMIN = 50e-9
AIRBOX_CLEARANCE_X = max((AIRBOX_X - LENGTH) * 0.5, 0.0)
AIRBOX_CLEARANCE_Y = max((AIRBOX_Y - WIDTH) * 0.5, 0.0)
AIRBOX_CLEARANCE_Z = max((AIRBOX_Z - HEIGHT) * 0.5, 0.0)
AIRBOX_SIDE_CLEARANCE = max(AIRBOX_CLEARANCE_X, AIRBOX_CLEARANCE_Y, AIRBOX_CLEARANCE_Z)
AIRBOX_CORNER_CLEARANCE = (
    AIRBOX_CLEARANCE_X**2 + AIRBOX_CLEARANCE_Y**2 + AIRBOX_CLEARANCE_Z**2
) ** 0.5
...
AIRBOX_TRANSITION_DISTANCE = AIRBOX_SIDE_CLEARANCE
AIRBOX_EDGE_HMAX = 120e-9
AIRBOX_EDGE_THICKNESS = 40e-9
AIRBOX_EDGE_TRANSITION_DISTANCE = AIRBOX_SIDE_CLEARANCE
AIRBOX_CORNER_TRANSITION_DISTANCE = AIRBOX_CORNER_CLEARANCE
