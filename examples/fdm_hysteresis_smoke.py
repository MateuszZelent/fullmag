"""Small FDM CPU hysteresis smoke test.

This case is intentionally tiny so the repository can verify the real
hysteresis runtime path without heavy meshing or large vector snapshots.
"""

import fullmag as fm


study = fm.study("fdm_hysteresis_smoke")

study.engine("fdm")
study.device("cpu", precision="double")
study.universe(
    mode="manual",
    size=(40e-9, 80e-9, 10e-9),
    center=(0.0, 0.0, 0.0),
    padding=(0.0, 0.0, 0.0),
)
