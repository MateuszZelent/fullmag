"""FEM GPU k=0 Kittel readiness fixture without demag.

This mirrors fem_eigen_k0_kittel_zeeman_no_demag.py but requests the FEM GPU
modal lane. It is expected to fail until a real modal GPU eigensolver exists;
the managed gate must not pass through CPU fallback.

Usage:
    FULLMAG_FEM_EXECUTION=gpu fullmag examples/fem_eigen_k0_kittel_zeeman_no_demag_gpu.py --headless
"""
...
study = fm.study("fem_eigen_k0_kittel_zeeman_no_demag_gpu")
study.engine("fem")
