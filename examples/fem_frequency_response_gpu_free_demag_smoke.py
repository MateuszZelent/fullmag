"""Small FEM GPU gamma/free frequency-response smoke with dynamic demag.

This exercises the hybrid production GPU driven-response slice: CUDA applies
the local/exchange tangent operator, while ordinary k=0 dynamic demag is
provided by the backend demag-tangent provider. This is not a periodic-airbox
or nonzero-k demag-k smoke.
"""

import fullmag as fm


study = fm.study("fem_frequency_response_gpu_free_demag_smoke")
study.engine("fem")
