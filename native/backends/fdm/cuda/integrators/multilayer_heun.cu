 ...
 *
 * This owner advances the first native multilayer timestep slice: demag-only
 * Heun dynamics over the per-layer state staged by fullmag_fdm_backend_create_v2.
 */
