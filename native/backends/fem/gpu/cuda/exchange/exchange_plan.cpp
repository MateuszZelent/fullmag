/*
 * GPU CUDA exchange planning source contract.
 *
 ...
 * and device CSR dimensions before enabling device-resident exchange stages.
 * It does not own Context construction, MFEM exchange assembly, CPU fallback exchange, integrator execution, or C ABI entrypoints.
 */
