...
pub(crate) struct ScriptRunSummary {
    ...
    pub demag_hypre_wait_in_enqueue_wall_time_ns: Option<u64>,
    pub demag_hypre_host_api_wall_time_ns: Option<u64>,
    pub demag_hypre_device_elapsed_time_ns: Option<u64>,
    pub demag_hypre_wait_out_enqueue_wall_time_ns: Option<u64>,
    pub demag_hypre_event_wait_count: Option<u64>,
    pub demag_hypre_timed_solve_count: Option<u64>,
