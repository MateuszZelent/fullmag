...
pub(crate) enum Command {
    ...
    ResumeJson {
        ...
        path: PathBuf,
        /// Raw FDM checkpoint JSON or a fullmag.backend_state.v1 envelope.
        #[arg(long)]
        checkpoint: PathBuf,
