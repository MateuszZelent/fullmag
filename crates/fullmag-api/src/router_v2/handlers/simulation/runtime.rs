...
pub async fn get_current_run(
    ...
    Ok(Json(CurrentRunResource {
        ...
        final_rotated_dmi_energy: run.final_e_rotated_dmi,
        ...
        stages: stage
            ...
            .map(|(index, record)| {
                ...
                StageExecutionRecordResource {
                    ...
                    mesh_generation_id: record.mesh_generation_id.clone(),
                    mesh_topology_fingerprint: record.mesh_topology_fingerprint.clone(),
