...
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_DIRECTION_H2D: u32 = 1;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_DIRECTION_D2H: u32 = 2;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_DIRECTION_DEVICE_INTERNAL: u32 = 3;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_DIRECTION_D2D: u32 = 4;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_REASON_SCALAR_REDUCTION_D2H: u32 = 2;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_REASON_ARTIFACT_READBACK_D2H: u32 = 3;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_REASON_CHECKPOINT_EXPORT_D2H: u32 = 4;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_REASON_CHECKPOINT_IMPORT_H2D: u32 = 5;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_REASON_STREAM_SYNCHRONIZE: u32 = 6;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_REASON_SOLVE_STATE_D2D: u32 = 9;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_REASON_CONTROL_STATE_H2D: u32 = 10;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_REASON_SOLVED_TRANSPORT_RHS: u32 = 11;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_STATUS_SUCCESS: u32 = 0;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_EVENT_FLAGS_LEGAL_V1: u32 = 0x3f;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_EVENT_TRANSFER: u32 = 0x01;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_EVENT_SYNCHRONIZATION: u32 = 0x02;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_EVENT_CADENCE_AUTHORIZED: u32 = 0x04;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_EVENT_SCIENTIFIC_COMMIT: u32 = 0x08;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_EVENT_PROVISIONAL: u32 = 0x10;
pub const FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_EVENT_FAILED: u32 = 0x20;
...
mod tests {
    ...
    fn public_charge_runner_constants_match_the_frozen_native_registry() {
        ...
        assert_eq!(FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_EVENT_FLAGS_LEGAL_V1, 0x3f);
        assert_eq!(FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_EVENT_TRANSFER, 0x01);
        assert_eq!(FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_EVENT_SYNCHRONIZATION, 0x02);
        assert_eq!(FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_EVENT_CADENCE_AUTHORIZED, 0x04);
        assert_eq!(FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_EVENT_SCIENTIFIC_COMMIT, 0x08);
        assert_eq!(FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_EVENT_PROVISIONAL, 0x10);
        assert_eq!(FULLMAG_FDM_GPU_TRANSPORT_TELEMETRY_EVENT_FAILED, 0x20);
