...
def _ledger(path: Path, *, status: str = "completed") -> None:
    ...
    for attempt, scenario, device, crossing_ps, error, torque, wall in (
        ...
        row = {
            **base,
            ...
            "nist_crossing_min_s": str((137.9 if case == "case_a" else 136.2) * 1e-12),
            "nist_crossing_max_s": str((139.9 if case == "case_a" else 138.3) * 1e-12),
