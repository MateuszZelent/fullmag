"""NIST µMAG SP4 case B with Fullmag rk45 (adaptive step).

Run interactively on GPU with:
    just fullmag build=True fem gpu tests/standard_problems/mumag/sp4/fem/scenarios/case_b_rk45_adaptive.py
...
study = fm.study("mumag_sp4_fem_case_b_rk45_adaptive")
study.engine("fem")
