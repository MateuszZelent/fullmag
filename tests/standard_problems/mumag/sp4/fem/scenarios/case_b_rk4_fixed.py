"""NIST µMAG SP4 case B with Fullmag rk4 (fixed step).

Run interactively on GPU with:
    just fullmag build=True fem gpu tests/standard_problems/mumag/sp4/fem/scenarios/case_b_rk4_fixed.py
...
study = fm.study("mumag_sp4_fem_case_b_rk4_fixed")
study.engine("fem")
...
study.solver(integrator="rk4", fix_dt=2e-13, gamma=2.211e5)
