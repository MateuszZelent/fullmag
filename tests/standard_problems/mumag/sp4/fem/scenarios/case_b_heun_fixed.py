"""NIST µMAG SP4 case B with Fullmag heun (fixed step).

Run interactively on GPU with:
    just fullmag build=True fem gpu tests/standard_problems/mumag/sp4/fem/scenarios/case_b_heun_fixed.py
...
study = fm.study("mumag_sp4_fem_case_b_heun_fixed")
study.engine("fem")
...
study.solver(integrator="heun", fix_dt=2e-13, gamma=2.211e5)
...
study.b_ext(*(-35.5e-3, -6.3e-3, 0.0))
