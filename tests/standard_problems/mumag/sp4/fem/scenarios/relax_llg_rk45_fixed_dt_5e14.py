...
Run interactively on GPU with:
    just fullmag build=True fem gpu tests/standard_problems/mumag/sp4/fem/scenarios/relax_llg_rk45_fixed_dt_5e14.py
...
study = fm.study("mumag_sp4_fem_relax_llg_rk45_fixed_dt_5e14")
study.engine("fem")
