"""NIST µMAG SP4 case A with Fullmag rk45 (fixed step).

Run interactively on GPU with:
    just fullmag build=True fem gpu tests/standard_problems/mumag/sp4/fem/scenarios/case_a_rk45_fixed.py
...
study = fm.study("mumag_sp4_fem_case_a_rk45_fixed")
study.engine("fem")
