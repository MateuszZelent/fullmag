"""Permalloy hole mesh-only region probe.

This probe mirrors the interactive permalloy box case, but keeps the study free
of solve stages so validation can inspect mesh/plan semantics quickly.
"""

import fullmag as fm


study = fm.study("permalloy_hole_mesh_only_probe")
study.engine("fem")
