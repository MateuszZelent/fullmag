...
NUMERICAL_METHODS_REFERENCE_PAGES = frozenset(
    {
        ...
        *(
            ...
            for section, pages in {
                ...
                "meshing": ("index", "fdm-grids", "fem-shared-domain", "airbox", "swept-meshes", "refinement"),
            }.items()
            for page in pages
        ),
    }
...
REFERENCE_PAGE_TITLES = {
    ...
    "python-api/outputs/dispersion-and-response.md": "Dispersion and Response",
...
PYTHON_API_REFERENCE_PAGES = {
    ...
    "python-api/problem/round-trip.md",
    "python-api/problem/validation.md",
    "python-api/geometry/transforms.md",
    "python-api/geometry/boolean-operations.md",
    "python-api/geometry/imported-geometry.md",
    "python-api/geometry/regions.md",
    "python-api/geometry/universe-and-domain.md",
    "python-api/geometry/auxiliary-geometry.md",
    "python-api/materials/elastic-materials.md",
    "python-api/materials/magnetostriction-laws.md",
    "python-api/magnets-and-textures/initial-magnetization.md",
    "python-api/magnets-and-textures/preset-textures.md",
    "python-api/current-and-excitations/current-transport.md",
    "python-api/current-and-excitations/prescribed-current.md",
    "python-api/current-and-excitations/regional-field-drive.md",
    "python-api/current-and-excitations/rf-drive.md",
    "python-api/current-and-excitations/microstrip-antenna.md",
    "python-api/current-and-excitations/cpw-antenna.md",
    "python-api/boundary-conditions/periodic-boundary-conditions.md",
    "python-api/boundary-conditions/floquet-boundary-conditions.md",
    "python-api/boundary-conditions/mechanical-boundary-conditions.md",
    "python-api/discretization/hybrid.md",
    "python-api/discretization/mesh-controls.md",
    "python-api/discretization/per-object-meshing.md",
    "python-api/dynamics/integrators.md",
    "python-api/dynamics/adaptive-timestep.md",
    "python-api/dynamics/field-refresh.md",
    "python-api/studies/relaxation.md",
    "python-api/studies/hysteresis.md",
    "python-api/studies/eigenmodes.md",
    "python-api/studies/frequency-response.md",
    "python-api/outputs/quantities.md",
    "python-api/outputs/modes-and-spectra.md",
    "python-api/outputs/dispersion-and-response.md",
    "python-api/outputs/snapshots.md",
    "python-api/outputs/autosave.md",
    "python-api/runtime/runtime-selection.md",
    "python-api/runtime/backend-policy.md",
    "python-api/runtime/simulation.md",
    "python-api/runtime/results.md",
    "python-api/runtime/artifacts.md",
    "python-api/runtime/provenance.md",
}
...
PAGE_SPECS: tuple[PageSpec, ...] = (
    ...
    *_section("numerical-methods/interpolation-and-state-transfer", "Interpolation and State Transfer", ("fem-to-fdm", "fdm-to-fem"), "the interpolation and state-transfer reference"),
    ...
    _reference("architecture/ui-architecture.md", "Control Room Architecture", "the Control Room application architecture reference", status="implemented"),
    ...
    _reference("architecture/planner-and-capabilities.md", "Planner and Capabilities", "the planner and capabilities reference"),
    _reference("architecture/provenance.md", "Provenance", "the provenance reference"),
)
