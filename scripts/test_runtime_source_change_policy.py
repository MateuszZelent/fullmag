...
def test_non_runtime_path_policy_covers_docs_ci_and_packaging_helpers() -> None:
    ...
    assert is_non_runtime_path("Codex-Usage")
    assert is_non_runtime_path("Codex-Usage/")
    assert is_non_runtime_path("Codex-Usage/local/metadata.json")
    assert is_non_runtime_path(".impl-racetrack")
    assert is_non_runtime_path(".impl-racetrack/")
    assert is_non_runtime_path(".impl-racetrack/run_output/metadata.json")
