...
const ICON_REGISTRY: Record<NodeKind, IconRegistryEntry> = {
  ...
  "universe.mesh.transition":              { token: "sliders-horizontal", label: "Mesh Transition" },
  "universe.mesh.statistics":              { token: "bar-chart-3",      label: "Mesh Statistics" },
  ...
  "mesh.transition":                       { token: "sliders-horizontal", label: "Mesh Transition" },
  "mesh.statistics":                       { token: "bar-chart-3",      label: "Mesh Statistics" },
