  ...
  return [
    {
      ...
      actions: [
        ...
        },
        {
          ...
          label: "Statistics",
          tooltip: "Open COMSOL-like mesh statistics by global domain, airbox and objects",
    ...
    },
    {
      ...
      actions: [
        ...
        },
        {
          ...
          disabled: !ctx.can({ id: "mesh.open-transition" }),
          action: () => ctx.run({ id: "mesh.open-transition" }),
    ...
    },
    {
      ...
      actions: [
        ...
        },
        {
          ...
          disabled: !ctx.can({ id: "mesh.open-optimization" }),
          action: () => ctx.run({ id: "mesh.open-optimization" }),
          iconColor: "text-emerald-400",
        },
      ],
    },
