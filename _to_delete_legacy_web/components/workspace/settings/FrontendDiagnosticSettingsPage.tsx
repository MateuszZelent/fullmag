...
const DESCRIPTIONS: Record<string, string> = {
  ...
  "leakIsolation.enableFemMeshView3DSceneMountWithoutVisualContent": "Allow the FEM R3F scene to mount even when geometry, arrows, and overlays are all disabled.",
  ...
  "leakIsolation.enableFemMeshView3DSharedColorFieldCollection": "Allow FemViewportScene to collect shared color fields before geometry rendering.",
  "leakIsolation.enableFemMeshView3DSharedVertexColorPrecompute": "Allow FemViewportScene to precompute shared per-node vertex color arrays.",
  "leakIsolation.enableFemMeshView3DGeometryColorUpload": "Allow FemGeometry to build and upload per-geometry color buffers.",
  "leakIsolation.enableFemMeshView3DMemoryDiagnostics": "Log FEM 3D scene/color memory estimates and cache stats to the browser console.",
