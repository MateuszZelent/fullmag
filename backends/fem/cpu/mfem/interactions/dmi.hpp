 ...
 * Conventional and rotated interfacial contributions share the combined
 * AOS-3 field buffer; the rotated term is also retained separately for its
 * public observable, and bulk uses its own buffer. The energy diagnostic is their
...
struct DmiRuntimeState {
    ...
    std::vector<double> h_rotated_interfacial_xyz;
    std::vector<double> h_bulk_xyz;
    double energy_joules = 0.0;
    double rotated_energy_joules = 0.0;
