...
/*
 * GPU CUDA transfer-audit module header.
 *
 * Declares transfer counters, hot-loop assertion gates, scope tracking, and
 * public snapshot helpers for FEM GPU residency auditing.
 */
