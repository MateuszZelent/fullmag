---
title: 'Docs settings'
description: 'How the wiki is configured through docs.json'
icon: 'gear'
---

The `wiki/docs.json` file controls the site title, colors, navigation, and top-level links.

## Properties

<ResponseField name="name" type="string" required>
Name of the wiki project. Used for the global title.

Example: `Fullmag Wiki`

</ResponseField>

<ResponseField name="navigation" type="Navigation[]" required>
  An array of tabs and page groups that define the wiki sidebar.
...
<ResponseField name="logo" type="string or object">
  Path to the logo image or object with separate light and dark assets.
...
<ResponseField name="colors" type="Colors">
  Hex color codes for the wiki theme.
...
<ResponseField name="api" type="API">
  Configuration for API settings. Useful when the wiki includes OpenAPI-backed pages.
