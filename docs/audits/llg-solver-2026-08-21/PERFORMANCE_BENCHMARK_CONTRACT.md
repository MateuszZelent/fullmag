...
Wymagane są przypadki mały, średni i duży oraz wyznaczenie break-even CPU/GPU. Dla FEM macierz rozmiarów musi zostać wykonana osobno dla każdego wspieranego jawnego integratora: Heun, RK4, RK23 i RK45, z każdą legalną dla niego polityką fixed/adaptive. Wynik `steps/s` bez kontroli błędu nie jest kwalifikacją wydajności solvera.
