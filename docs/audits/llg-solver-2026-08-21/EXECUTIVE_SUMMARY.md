...
2. Adaptacyjna norma błędu zachowuje kanoniczne maksimum wektorowe `LLG-TD-MAX-ERR-V1` po aktywnych komórkach/węzłach; RMS nie może rozcieńczać lokalnego dużego błędu wraz ze wzrostem siatki.
