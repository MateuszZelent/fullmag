...
| T4 | in_progress | 67268171221e2ed3bc4cf96b4dd1977bdb1b6c5e | 2c628f7147dbc6ec5ecbe66325b00bb72c79b85523b4c158ce5cf536c75fd8b9 | docs/audits/2026-08-02-fem-t4-coarse-parity-measurement.json; .superpowers/sdd/task-4-report.md; scripts/validate_fem_relaxation_equilibrium_parity.py; scripts/test_validate_fem_relaxation_equilibrium_parity.py; scripts/verify_fem_relaxation_equilibrium_parity_semantics.py; scripts/analysis/fem_gpu_benchmark.py; examples/bench_fem_gpu_long.py; examples/assets/fem_performance/equilibrium_qualification_suite_v1.json; docs/physics/0580-canonical-relaxation-equilibrium-contract.md; docs/physics/0580-canonical-relaxation-equilibrium-contract.source-map.json; justfile | blocked_by_measurement | 67268171221e2ed3bc4cf96b4dd1977bdb1b6c5e | Exact schema-v3 runtime (`MFEM 4.9`, `HYPRE 3.1.0`, CC 8.9, source snapshot `47d21986...`, source inputs `daf75f9e...`) reran the full coarse eight-row matrix. Typed solver-mesh groups and demag residuals passed; direction policy still differs (`exchange_plus_mass_tangent_gradient` CPU vs `device_tangent_gradient` GPU). The 1e-9 final-magnetization gate still fails with max differences `0.06503967931218391` (PG-BB) and `0.005650088291763944` (NCG). Demag apply speedups were `1.419x` (PG-BB) and `1.864x` (NCG), but no equilibrium or end-to-end speedup is claimed. A device-resident GPU counterpart to the CPU exchange-plus-mass direction remains required. |
