...
dla zdalnego transportu, retry/orphan reconciliation, pełnego process E2E
anulowania oraz process E2E pozostałych lane'ów.
...
i [`33-operator-task-cancellation.md`](33-operator-task-cancellation.md).
