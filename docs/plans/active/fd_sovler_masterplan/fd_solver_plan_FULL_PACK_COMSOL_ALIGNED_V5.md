...
| `modal_gpu_k0_periodic_airbox_scalable` | `source_visible` | `unvalidated` | `null` | Source and bounded CUDA-contract evidence only. | Managed real-assembly GPU execution, CPU/GPU parity, scaling and release qualification are missing. |
...
<!-- BEGIN 27_fem_k0_eigensolve_production_completion_and_control_room.md -->
...
```
<!-- END 27_fem_k0_eigensolve_production_completion_and_control_room.md -->
