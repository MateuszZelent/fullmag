...
- [x] Runner persists `mesh/fdm_transfer_provenance.v1.json` with source/target grid fingerprints, grid geometry and boundary policy; focused fixture `fdm_multilayer_persists_transfer_provenance_artifact` — 1 passed.
- [ ] Managed CUDA/runtime proof remains open; do not close the finding until the managed gate is green.
