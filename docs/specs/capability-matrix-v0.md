...
| `Demag` | ✅ exec | ✅ exec | planned | **public-executable** (FDM/FEM) | FDM uses Newell tensor FFT; executable FEM uses MFEM-native CPU/GPU paths with transfer-grid and Poisson demag realizations |
