...
| `spin_torque.prescribed_sot` | `prescribed_sot.fullmag.v1` | FEM / GPU / double / strict | canonical signed-current macrospin | `semantic_only` | planner and native runner fail closed before FFI; no CUDA SOT realization or CPU fallback exists |
