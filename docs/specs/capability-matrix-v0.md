...
| `transport.spin.memory_loss` | `sml_reservoir.fullmag.v2` | FDM/FEM / CPU/GPU / double / strict | `sml_reservoir_balance_v2`, `sml_reservoir_entropy_v2` | `unsupported` | authoring/IR contract only; reservoir weak form and surface entropy gate are not executable |
