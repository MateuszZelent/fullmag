...
ścieżka `ProblemIR`--planner--runner uruchamia teraz wyłącznie osobno opisaną,
bounded `CurrentTransport` charge-only realizację FDM/CUDA/FP64/strict; steady
spin, direct SHE, mixing i torque nadal nie mają realizacji CUDA. Dla
