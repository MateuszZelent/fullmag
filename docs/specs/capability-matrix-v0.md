...
| explicit adaptive | FDM | CUDA | single | `production_executable` | executable | unvalidated | RK23/RK45 FP32 przechodzi ten sam natywny batched oracle, rollback, telemetrykę synchronizacji i precision-specific parity budget. Publiczny headless routing współdzieli realizację z FP64, ale brak osobnego publicznego artefaktu E2E i szerokiej kwalifikacji interakcji; lane nie dziedziczy kwalifikacji FP64 i pozostaje `unvalidated`. |
