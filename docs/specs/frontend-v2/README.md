...
23. `26-viewport-3d-surface-field-projection.md` - diagnostic projection modes for 3D surface shader coloring, including raw nodal, flat surface-face, and thickness-average views.
