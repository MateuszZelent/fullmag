...
and qualifying 2D, charts, console, and results workflows.

**Legacy status:** `apps/legacy_web` remains reference-only.

**Cutover status:** This marker does not declare cutover, freeze, or removal.
