...
verify-fdm-multilayer-cuda-runtime lane="cuda-fp64":
    bash -euo pipefail -c '\
      ...
      printf "%s\n" "just verify-fdm-multilayer-cuda-runtime $lane" > "$run_root/command.txt"; printf "%s\n" "d07_telemetry_not_qualified" "cuda_assisted_multilayer_not_qualified" "cuda_native_multilayer_demag_v2_not_proven" "cuda_fallback_not_proven_absent" "cpu_cuda_parity_not_qualified" "managed_runtime_source_snapshot_mismatch" "source_drift_after_runtime" "input_hash_drift_after_runtime" "source_hash_drift_after_runtime" > "$run_root/failure-reason-codes.txt"; \
